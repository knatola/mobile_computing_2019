...
class MainActivity : AppCompatActivity() {
    ...
    private fun animateNavigation(fragment: Fragment) {
        ...
        if (fragment is DayFragment) {
            cs.connect(R.id.nav_selector, ConstraintSet.START, R.id.today_action, ConstraintSet.START, 0)
            cs.connect(R.id.nav_selector, ConstraintSet.END, R.id.today_action, ConstraintSet.END, 0)
            cs.connect(R.id.nav_selector, ConstraintSet.TOP, R.id.today_action, ConstraintSet.BOTTOM, 2)
        ...
        if (fragment is WeekFragment) {
            cs.connect(R.id.nav_selector, ConstraintSet.START, R.id.week_action, ConstraintSet.START, 0)
            cs.connect(R.id.nav_selector, ConstraintSet.END, R.id.week_action, ConstraintSet.END, 0)
            cs.connect(R.id.nav_selector, ConstraintSet.TOP, R.id.week_action, ConstraintSet.BOTTOM, 2)
        ...
        if (fragment is ReminderFragment) {
            cs.connect(R.id.nav_selector, ConstraintSet.START, R.id.reminder_action, ConstraintSet.START, 0)
            cs.connect(R.id.nav_selector, ConstraintSet.END, R.id.reminder_action, ConstraintSet.END, 0)
            cs.connect(R.id.nav_selector, ConstraintSet.TOP, R.id.reminder_action, ConstraintSet.BOTTOM, 2)
